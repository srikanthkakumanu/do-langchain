...
| HuggingFace  | sentence-transformers/all-mpnet-base-v2 | huggingface    | Free          | 768                                         | Free (Inference API, rate-limited) / Free to self-host                      |
| HuggingFace  | multi-qa-mpnet-base-cos-v1             | huggingface    | Free          | 768                                         | Free (Inference API, rate-limited) / Free to self-host                      |
