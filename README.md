...
- [docs/rag/Advanced_RAG.md](docs/rag/Advanced_RAG.md) — A detailed Advanced RAG tutorial paired with [src/context_engineering/rags/advanced_rag.py](src/context_engineering/rags/advanced_rag.py), adding query rewriting, Pinecone storage/retrieval, reranking, augmentation, and generation diagnostics.
